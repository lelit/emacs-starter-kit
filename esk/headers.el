...
(define-skeleton esk/file-header:evolutive
  ...
  "#+COLUMNS: %40ITEM(Voce) %13Effort(Ore stimate){:}\n"
  "#+LANGUAGE: it\n"
  "#+LATEX_CLASS_OPTIONS: [a4paper,11pt]\n"
  "#+LATEX_HEADER: \\usepackage[italian]{babel}\n"
  "#+LATEX_HEADER: \\usepackage[margin=2.5cm]{geometry}\n"
  ...
  "# Local IspellDict: italiano\n\n"
  "* Sommario tempi\n\n"
  "  #+BEGIN: columnview :id global :maxlevel 2 :skip-empty-rows t :format \"%40ITEM(Voce) %13Effort(Ore stimate){:} %CLOCKSUM(Ore lavorate)\"\n"
  "  #+END:\n\n"
